import { computePlan, currentWeekNumber, isCheckinComplete, avgCalories } from "@/lib/plan";
...
export function buildClientRow(lead, checkins) {
  ...
  const planStatus =
    lead.tier === "diy" ? (isCheckinComplete(byWeek.get(1)) ? "auto" : "—") : lead.macro_targets ? "set" : "not-set";
